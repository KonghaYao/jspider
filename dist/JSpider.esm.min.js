 ...
 * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
 * SPDX-License-Identifier: Apache-2.0
 */const tc=new Zu,rc=tc.createSource$("TaskUpdate"),nc=tc.createSource$("ControlUpdate");
/**
 * @license
 * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
 * SPDX-License-Identifier: Apache-2.0
 */
var ic={stateChange(e){this.status=e,tc.emit("ControlUpdate",{name:"stateChange",value:e})},"Flow:stop"(){this._stop=!0,tc.emit("ControlUpdate",{name:"flowStop"})},"Flow:start"(){console.log("jspider 开始运行"),this.status="pending",this._stop=!1,tc.emit("ControlUpdate",{name:"flowStart"})},"Task:success"(e){e.$commit("complete"),e instanceof ec&&e.$destroy(),tc.emit("ControlUpdate",{name:"TaskSuccess"})},"Task:error"(e){console.log(e)}};
/**
 * @license
 * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
 * SPDX-License-Identifier: Apache-2.0
 */function oc(){const e=this.$store.$backup();tc.emit("TaskUpdate",e)}class ac{#Tasks=new Map;viewModel=[];createTask(e,t){const r=new Ju(e,t);this.#Tasks.set(r.uuid,r);const n=this;return r.$on({start:oc,success:oc,complete:oc,error:oc,destroy(){n.#Tasks.delete(this.uuid)}}),this.viewModel.push(r.$store),r}}
/**
 * @license
 * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
 * SPDX-License-Identifier: Apache-2.0
 */class sc{QueuePromise=Promise.resolve();enQueue(...e){return this.QueuePromise=e.reduce(((e,t)=>e.then(t)),this.QueuePromise),this}}
/**
 * @license
 * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
 * SPDX-License-Identifier: Apache-2.0
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
function zc(e=3,t=1e3){return r=>new Lo((n=>{const i=new Set;let o=0;const a=()=>{i.size&&(n.next([...i]),i.clear())},s=r.subscribe((r=>{switch(console.log(o),o&&(clearTimeout(o),o=0),i.size){case 0:return i.add(r);case e-1:return i.add(r),a();default:return o=setTimeout(a,t),i.add(r)}}),la,(()=>{a(),n.complete()}));return()=>{i.clear(),s.unsubscribe()}}))}
/**
 * @license
 * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
 * SPDX-License-Identifier: Apache-2.0
