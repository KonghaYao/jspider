...
/**
   ...
   * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
   * SPDX-License-Identifier: Apache-2.0
   */function gc(){const e=this.$store.$backup();bc.emit("TaskUpdate",e)}class mc{#Tasks=new Map;viewModel=[];createTask(e,t){const r=new pc(e,t);this.#Tasks.set(r.uuid,r);const n=this;return r.$on({start:gc,success:gc,complete:gc,error:gc,destroy(){n.#Tasks.delete(this.uuid)}}),this.viewModel.push(r.$store),r}}
/**
   * @license
   * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
   * SPDX-License-Identifier: Apache-2.0
...
/**
   ...
   * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
   * SPDX-License-Identifier: Apache-2.0
   */class xc{constructor({forceRetry:e=!0,saveResult:t=!1,name:r=null,main:n,init:i=null,error:o=null,complete:a=null,options:s={},operator:u}){u&&(this.operator=u),Object.assign(this,{name:r,main:n,init:i,error:o,complete:a,options:s,saveResult:t,forceRetry:e})}initUUID(e){this.uuid=wc(this.main.toString()+e)}TaskStarter(e){return _a(e).pipe(oc((e=>_a(e).pipe(ja((e=>[e.$commit("start",this.uuid),e._originData])),oc((([e,t])=>{const r=this.main(e,t);return r instanceof Promise||r instanceof Jo?Na(r):_a(r)})),ja((t=>(e.$commit("success",t,this.uuid,this.saveResult),e)))))),Hu(((...t)=>{if(this.error instanceof Function){const r=this.error(e,...t);if(r)throw new Sc(r);return da}throw new Sc(t[0])})),uc((e=>this.complete&&this.complete(e))))}operator(e){return Xo(oc((e=>this.TaskStarter(e))))}}function Ec(e,t={}){if(e instanceof Function)return new xc(Object.assign(t,{main:e}));if(e instanceof Object)return new xc(e);throw new Sc("Plugin 必须是一个函数或者是 Plugin 描述对象")}
/**
   * @license
   * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
   * SPDX-License-Identifier: Apache-2.0
   */const Tc=(e,t)=>{return Xo((r=r=>r.pipe(function(e,t){var r=!1;return arguments.length>=2&&(r=!0),function(n){return n.lift(new Zu(e,t,r))}}(((t,r)=>{if(console.log("尝试次数",t,r),t>=e)throw new Ac("超出尝试次数",r);return t+1}),0),qu(((...e)=>{switch(typeof t){case"string":case"number":return Ka(parseInt(t,10));case"function":return Ka(t(...e));default:throw new Ac("您输入的 delay 错误")}}))),function(e){return e.lift(new tc(r,e))}));
/**
   * @license
   * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
   * SPDX-License-Identifier: Apache-2.0
   */var r};function Ic({url:e,options:t={}}){const{returnType:r="json"}=this.options;return console.log("- 爬取 ",e),fetch(e,t).then((e=>{if(!e.ok)throw Error(e.statusText);
/**
   * @license
   * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
   * SPDX-License-Identifier: Apache-2.0
   */
return function(e,t){const r=e.headers.get("content-type")||"";return t&&"auto"!==t?t?e[t]():e.json():/text|html|rtf|xml/.test(r)?e.text():/json/.test(r)?e.json():/arrayBuffer/.test(r)?e.arrayBuffer():e.buffer?e.buffer():e.blob()}(e,r)})).then((t=>(console.log(`${e} 爬取成功`),t))).catch((e=>{throw e}))}function Cc(e){throw e}
/**
   * @license
   * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
   * SPDX-License-Identifier: Apache-2.0
...
/**
   ...
   * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
   * SPDX-License-Identifier: Apache-2.0
   */const Mc=Object.entries({npm:/^npm?/i,gh:/gh?|github/i,wp:/wordpress|wp/i});function Fc(e,{version:t="",store:r="npm",path:n=""}={}){return`https://cdn.jsdelivr.net/${Mc.reduce(((e,[t,n])=>n.test(r)?t:e),"npm")}/${e}${t?`@${t}`:""}${n?`/${n}`:""}`}
/**
   * @license
   * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
   * SPDX-License-Identifier: Apache-2.0
...
/**
   ...
   * SPDX-License-Identifier: Apache-2.0
   */
var Zc=Object.freeze({__proto__:null,Request:function(e={}){return Ec({init(){},name:"Request",main:Ic,options:e,operator(){const{delay:e=200,buffer:t=3,retry:r=3,handleError:n=null}=this.options;return i=>i.pipe(function(e,{retry:t=3,buffer:r=3,delay:n=1e3,retryDelay:i=300,handleError:o=function(e,t){throw new Error(e,t)}}={}){return Xo(Ru(1e3,void 0,r),Ha((e=>e.length)),qu(((e,t)=>Ka(t*n))),Ma((e=>Na(e))),Ku((r=>_a(r).pipe(Ma((t=>e(t))),Tc(t,i),Hu(((...e)=>(o instanceof Function?o(...e):o)||da))))))}((e=>this.TaskStarter(e)),{delay:e,buffer:t,retry:r,handleError:n||Cc}))}})},Download:function(e={}){return Ec({name:"Download",main:Vc,options:e})},ExcelHelper:function(e,t={}){return Ec({name:"ExcelHelper",init:Gc,options:t,main(t){const{fileName:r="result",XLSXOptions:n={}}=this.options;return e instanceof Function&&(t=e(t)),qc(t,`${r}-${(new Date).getTime()}`,n)}})},ZipFile:function(e={}){return e.zipFileName||(e.zipFileName=(new Date).getTime()),Ec({init:Yc,name:"zipFile",main(e){const{zipFileName:t}=this.options;return async function(e,t){const r=new Wc;e.forEach((e=>r.file(e.name,e)));const n=await r.generateAsync({type:"blob"});return n.name=`${t}-${Qc++}.zip`,n}(e.map((e=>kc(e,t))),t)},options:e,operator(){const{chunk:e=3}=this.options;return t=>t.pipe(Ru(5e3,void 0,e),Ha((e=>e.length)),Ku((e=>this.TaskStarter(new Xc(e),this.uuid))))}})}});
/**
   * @license
   * Copyright 2021 KonghaYao 江夏尧 <dongzhongzhidong@qq.com>
   * SPDX-License-Identifier: Apache-2.0
