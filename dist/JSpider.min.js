...
var JSpider = (function () {
    ...
    ***************************************************************************** */
    ...
    function fromEventPattern(addHandler, removeHandler, resultSelector) {
        if (resultSelector) {
            return fromEventPattern(addHandler, removeHandler).pipe(map$1(function (args) { return isArray$2(args) ? resultSelector.apply(void 0, args) : resultSelector(args); }));
        }
        return new Observable(function (subscriber) {
    ...
    function deepEnhancer(v, _, name) {
      ...
      if (isPlainObject$1(v)) return observable.object(v, undefined, {
        name: name
      });
    ...
    function createObservable(v, arg2, arg3) {
      ...
      if (isPlainObject$1(v)) return observable.object(v, arg2, arg3); // Array
    ...
    function createActionFactory(autoAction) {
      var res = function action(arg1, arg2) {
        // action(fn() {})
        if (isFunction$1(arg1)) return createAction(arg1.name || DEFAULT_ACTION_NAME, arg1, autoAction); // action("name", fn() {})

        if (isFunction$1(arg2)) return createAction(arg1, arg2, autoAction); // @action
    ...
    function intercept(thing, propOrHandler, handler) {
      if (isFunction$1(handler)) return interceptProperty(thing, propOrHandler, handler);else return interceptInterceptable(thing, propOrHandler);
    }
    ...
    function observe(thing, propOrCb, cbOrFire, fireImmediately) {
      if (isFunction$1(cbOrFire)) return observeObservableProperty(thing, propOrCb, cbOrFire, fireImmediately);else return observeObservable(thing, propOrCb, cbOrFire);
    }
    ...
    function eq$1(a, b, depth, aStack, bStack) {
      ...
      var type = typeof a;
      if (!isFunction$1(type) && type !== "object" && typeof b != "object") return false; // Compare `[[Class]]` names.
    ...
    ***************************************************************************** */
    ...
    class PLUGIN$1 {
        ...
        TaskStarter(task) {
            return of(task).pipe(
                ...
                switchMap((task) => {
                    return of(task).pipe(
                        map$1((task) => [task.$commit('start', this.uuid), task._originData]),
    ...
    var index = Object.assign(Spider, tools, {
        ...
        version: "3.1.8",
        buildDate: new Date(1628151252818),
    });
