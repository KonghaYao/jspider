...
var JSpider = (function () {
    ...
    ***************************************************************************** */
    ...
    scope, args) {
      ...
      if (notifySpy_) {
        startTime_ = Date.now();
        var flattenedArgs = args ? Array.from(args) : EMPTY_ARRAY$1;
        spyReportStart({
          type: ACTION,
          name: actionName,
          object: scope,
    ...
    var ObservableObjectAdministration = /*#__PURE__*/function () {
      ...
      _proto.defineObservableProperty_ = function defineObservableProperty_(key, value, enhancer, proxyTrap) {
        ...
        try {
          ...
          var observable = new ObservableValue(value, enhancer, undefined !== "production" ? this.name_ + "." + key.toString() : "ObservableObject.key", false);
      ...
      _proto.defineComputedProperty_ = function defineComputedProperty_(key, options, proxyTrap) {
        ...
        try {
          ...
          options.name || (options.name = undefined !== "production" ? this.name_ + "." + key.toString() : "ObservableObject.key");
    ...
    function asObservableObject(target, options) {
      ...
      var name = (_options$name = options == null ? void 0 : options.name) != null ? _options$name : (isPlainObject$1(target) ? "ObservableObject" : target.constructor.name) + "@" + getNextId() ;
    ...
    ***************************************************************************** */
    ...
    class Spider {
        constructor(config = {}) {
            this.config = config;
            this.$EventHub = new EventHub(staticEvent$1, this); // 注册静态事件
        }
        crawl(...args) {
    ...
    var index = Object.assign(Spider, tools, {
        ...
        version: "3.1.8",
        buildDate: new Date(1627872090616),
    });
