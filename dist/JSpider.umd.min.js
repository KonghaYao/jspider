...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.JSpider = factory());
  ...
  function addHiddenProp(object, propName, value) {
    defineProperty$2(object, propName, {
      enumerable: false,
      writable: true,
      configurable: true,
      value: value
  ...
  function deepEnhancer(v, _, name) {
    ...
    if (isES6Map(v)) return observable$1.map(v, {
      name: name
    });
    if (isES6Set(v)) return observable$1.set(v, {
      name: name
    });
  ...
  function make_$1(adm, key, descriptor, source) {
    ...
    defineProperty$2(source, key, actionDescriptor);
    return 2
    /* Continue */
    ;
  }
  ...
  function make_$2(adm, key, descriptor, source) {
    ...
    defineProperty$2(source, key, flowDescriptor);
    return 2
    /* Continue */
    ;
  }
  ...
  function make_$5(adm, key, descriptor, source) {
    ...
    var observableAnnotation = ((_this$options_3 = this.options_) == null ? void 0 : _this$options_3.deep) === false ? observable$1.ref : observable$1; // if function respect autoBind option
  ...
  function extend_$5(adm, key, descriptor, proxyTrap) {
    ...
    var observableAnnotation = ((_this$options_6 = this.options_) == null ? void 0 : _this$options_6.deep) === false ? observable$1.ref : observable$1;
  ...
  function createObservable(v, arg2, arg3) {
    ...
    if (isPlainObject$1(v)) return observable$1.object(v, arg2, arg3); // Array

    if (Array.isArray(v)) return observable$1.array(v, arg2); // Map

    if (isES6Map(v)) return observable$1.map(v, arg2); // Set

    if (isES6Set(v)) return observable$1.set(v, arg2); // other object - ignore

    if (typeof v === "object" && v !== null) return v; // anything else

    return observable$1.box(v, arg2);
  }
  ...
  function createActionFactory(autoAction) {
    var res = function action(arg1, arg2) {
      // action(fn() {})
      if (isFunction$2(arg1)) return createAction(arg1.name || DEFAULT_ACTION_NAME, arg1, autoAction); // action("name", fn() {})

      if (isFunction$2(arg2)) return createAction(arg1, arg2, autoAction); // @action
  ...
  function cancelPromise(promise) {
    if (isFunction$2(promise.cancel)) promise.cancel();
  }
  function isFlow(fn) {
  ...
  function intercept(thing, propOrHandler, handler) {
    if (isFunction$2(handler)) return interceptProperty(thing, propOrHandler, handler);else return interceptInterceptable(thing, propOrHandler);
  }
  ...
  function observe(thing, propOrCb, cbOrFire, fireImmediately) {
    if (isFunction$2(cbOrFire)) return observeObservableProperty(thing, propOrCb, cbOrFire, fireImmediately);else return observeObservable(thing, propOrCb, cbOrFire);
  }
    ...
    _proto.defineProperty_ = function defineProperty_(key, descriptor, proxyTrap) {
      ...
      try {
        ...
        if (proxyTrap) {
          ...
          defineProperty$2(this.target_, key, descriptor);
        } // Notify
  ...
  function createArrayBufferItem(index) {
    defineProperty$2(LegacyObservableArray.prototype, "" + index, createArrayEntryDescriptor(index));
  }
  ...
  function eq$1(a, b, depth, aStack, bStack) {
    ...
    var type = typeof a;
    if (!isFunction$2(type) && type !== "object" && typeof b != "object") return false; // Compare `[[Class]]` names.
    ...
    if (areArrays) {
      ...
      while (length--) {
        if (!eq$1(a[length], b[length], depth - 1, aStack, bStack)) return false;
      }
    } else {
      ...
      while (length--) {
        ...
        key = keys[length];
        if (!(hasProp(b, key) && eq$1(a[key], b[key], depth - 1, aStack, bStack))) return false;
      }
  ...
  ***************************************************************************** */
   ...
   * @hidden
   */
  function defineProperty$1(object, key, descriptor) {
  ...
  var CoreType = /** @class */ (function (_super) {
      ...
      function CoreType(name, flags, checker, initializer) {
          if (initializer === void 0) { initializer = identity$2; }
          var _this = _super.call(this, name) || this;
          Object.defineProperty(_this, "flags", {
              enumerable: true,
              configurable: true,
   ...
   */
  function createProps({ spiderUUID, originData }) {
      // 创建初始化的参数
      return {
          uuid: v4(),
  ...
  function createTaskStore(model) {
  ...
  ***************************************************************************** */
  ...
  function Plugin$1(Process, otherOptions = {}) {
  ...
  const URLTest$1 = /(https?|ftp|file):\/\/[-A-Za-z0-9+&@#/%?=~_|!:,.;]+[-A-Za-z0-9+&@#/%=~_|]/;
   ...
   * @return {any}
   */
  function fromName$1({ name, way, path, version }) {
  ...
  const handle$1 = {
      Object({ url = '', name, way = 'npm', path = '', version = '', type = 'script' }) {
          if (!url) {
              // 没有 url 属性
              const result = fromName$1({ name, way, path, version });
              if (typeof result === 'string') {
                  url = result;
              } else {
                  // 发现 scriptMap 内部的描述是完整的 $load 可以接收的 array 和 object 类型
                  return $load$1(result);
              }
          }
          return loaderFunction[type](url);
      },
      String(Module) {
          return this.Object({ [URLTest$1.test(Module) ? 'url' : 'name']: Module });
      },
      Array(arr) {
          return Promise.all(arr.map((i) => $load$1(i)));
      },
  };
  async function $load$1(Module) {
      return handle$1[type$1(Module)](Module);
  }
  ...
  function BufferCountIn(countNumber = 3, maxWaitTime = 1000) {
      return (observable) =>
          new Observable((subscriber) => {
              const buffers = new Set();
   ...
   * SPDX-License-Identifier: Apache-2.0
   */
  function Combine(number, waitTime = 1000, combineFunction = undefined) {
      return Plugin$1({
  ...
  async function $load(Module) {
      return handle[type$1(Module)](Module);
  }
  ...
  function Plugin(Process, otherOptions = {}) {
      if (Process instanceof Function) {
          return new PLUGIN(
              Object.assign(otherOptions, {
                  main: Process,
  ...
  var index = Object.assign(Spider, tools, {
      ...
      TaskGroup,
      version: "3.2.3",
      buildDate: new Date(1628497828236),
  });
